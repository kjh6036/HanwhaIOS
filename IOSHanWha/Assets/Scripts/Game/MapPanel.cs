...
public class MapPanel : MonoBehaviour
{
    ...
    [SerializeField] private Image[] Potion_Image_Array = null;
    [SerializeField] private GameObject[] Check_Image_Array = null;
    ...
    private void OnEnable()
    {
        ...
        for (int i = 0; i < MiniGameManager.Instance.Card_Array.Length; i++)
        {
            ...
            {
                Potion_Image_Array[i / 2].color = new Color(1.0f, 1.0f, 1.0f, 1.0f);
                Check_Image_Array[i / 2].gameObject.SetActive(true);
                index++;
